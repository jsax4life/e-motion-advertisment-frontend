...
const EditOrderModal: React.FC<BillboardCreationModalProps> = ({
  isOpen,
  isLoading,
  campaign,
  onClose,
...
<div className="col-span-12 ">
            ...
            {/* Billboard Code */}
             ...
             <div className="col-span-12">
              ...
              <FormInput
              formInputSize="lg"
              defaultValue={campaign?.internalCode}
                id="internalCode"
                type="text"
              ...
              <div className="col-span-12">
                ...
                <FormInput
                formInputSize="lg"
                defaultValue={campaign?.billboardName}
                  id="billboardName"
                  type="text"
                  placeholder="Type here"
              ...
              <div className="space-y-2">
                ...
                { errors.lng  && ( <p className="text-red-500">{errors.lng.message?.toString()} </p>)} */}
                  ...
                  <div className="col-span-12">
                    ...
                    formSelectSize="lg"
                    defaultValue={campaign?.orientation}
                ...
                {campaign?.dimension && (
                                  ...
                                  defaultValue={campaign?.dimension}
                                 {...register("dimension", {
                                  onChange: (e) => {
                                    handleChange(e);
                                  },
...
{(campaign.dimension === "Custom" || formData.dimension === "Custom")  && (
       ...
       />
              ...
              <div className="col-span-12">
                ...
                <FormSelect
                  id="billboardType"
                  formSelectSize="lg"
                    defaultValue={campaign?.billboardType}
                    disabled
              ...
              {campaign.billboardType === "digital" && (
                <div className="col-span-12">
              ...
              <div className="col-span-12">
                ...
                formInputSize="lg"
                  // name="pricePerDay"
                  type="number"
                  defaultValue={campaign?.pricePerDay}
              ...
              <div className="col-span-12">
                ...
                disabled
                  type="text"
                  value={formatCurrency(Number(formData.pricePerMonth? formData.pricePerMonth : campaign.pricePerMonth))}
