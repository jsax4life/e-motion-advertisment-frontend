...
export const ActiveRoleSection: React.FC<ActiveRoleSectionProps> = ({
  ...
  return (
    <div className="flex">
      <nav className="flex flex-col items-start gap-8 p-6 self-stretch bg-neutralneutral-bg-day rounded-[10px_0px_0px_10px] border border-solid border-neutralneutral-border-day h-full overflow-y-auto min-w-[200px]">
          ...
          {roles.map((role) => {
            ...
            return (
              <Button
                ...
                className={`lg:w-[170px] justify-start p-4 py-2.5 rounded-lg 
                  ${isActive 
